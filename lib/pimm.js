(function() {
  ...
  var keylime = require('keylime'),
      ...
      renderExtension = mach.extend(require('./mach/render_extension')),
  ...
  Pimm
    ...
    .attr('_controller_manager', ControllerManager.create.bind(ControllerManager))
    .attr('_view_manager', ViewManager.create.bind(ViewManager))
    .attr('_router', Router.create.bind(Router))
    .attr('_config', {})
    .attr('_middleware', [])
